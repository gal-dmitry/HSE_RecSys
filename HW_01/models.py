...
class ALS():
    ...
    def __init__(self, rank=64, max_epochs=100, eps=1e-5, lambd=1e-5, confidence=10, seed=42):
        self.rank = rank
        self.max_epochs = max_epochs
        self.eps = eps
        self.lambd = lambd
...
class BPR():
    ...
    def update(self, user_id, prefers_id, over_id):
        ### product
    ...
    def fit(self, user_item_csr):
        ...
        for epoch in range(self.max_epochs):
            ...
            for user_id, prefers_id in tqdm(D):
                ...
                # update
                sigm = self.update(user_id, prefers_id, over_id)
